...
def seed_recipes():
    ...
    r50 = Recipe(
        user_id=12,
        title='Brioche Buns with Sweet Corn, Cheddar, and Cilantro',
        description="Baked in a cluster in a cake pan, these cheesy pull-apart buns studded with corn and cilantro are perfect for sharing. They can be customized with whatever cheese and seasonings you have on hand. The shaped buns can be frozen, wrapped tightly in plastic, for up to 3 weeks. Thaw in the refrigerator the night before you plan to bake them, then proof at room temperature.",
        image_url='https://www.saveur.com/uploads/2019/04/19/IC3LI73F47ZMNWHJRJHIGWU36A.jpg',
        total_time='10 hours 30 minutes',
        servings='makes 12',
        ingredients='⅓ cups (2½ ounces) whole milk, 3 large eggs (divided), 1⅔ cups (10 oz.) bread flour plus more for dusting, 2 tablespoon (½ oz.) sugar, 1½ teaspoon fresh yeast, 1¾ teaspoon kosher salt, 1 temperature stick & 1 tablespoon (4½ ounces) (unsalted butter room & diced), 6 ounces drained canned corn (1 cup), 3 ounces finely grated cheddar (1 cup),  ⅓ cups finely chopped cilantro, Nonstick cooking spray or canola oil for brushing',
        directions="In a stand mixer fitted with the paddle attachment, add the milk, 2 eggs, flour, sugar, yeast, and salt. Mix on low speed until the dry ingredients are completely moistened, about 2 minutes. Increase the speed to medium and mix, scraping down the sides of the bowl as needed, until a glossy dough forms and pulls away from the sides, 9–11 minutes. Scrape the dough off the paddle, add the butter, and mix on low speed for 1 minute. Increase the speed to medium and continue mixing, scraping down the sides and bottom of the bowl as needed, until the butter is incorporated, and the dough is very silky, shiny, and completely homogeneous, 3–4 minutes. Mix in the corn, cheddar, and cilantro until completely incorporated, 2–3 minutes more. Lightly grease a large bowl with cooking spray, then transfer the dough to the bowl. Cover with a lid or plastic wrap and refrigerate for at least 6 hours or overnight. Lightly grease a 9-inch square cake pan with cooking spray. Turn the dough out onto a lightly floured work surface. Using a bench scraper or a large knife, divide the dough into 12 equal pieces, about 2 ounces each. Shape each piece into a tight ball. Transfer the buns to the prepared pan (their sides will be touching). Loosely cover with plastic wrap and set aside at room temperature until very gassy, puffed, and just slightly more than doubled in size, about 3 hours. Preheat the oven to 325°F with a rack in the center. In a small bowl, whisk the remaining egg with 1 tablespoon cold water. Brush the tops of the buns with egg wash, then immediately transfer to the oven. Bake until the buns are evenly golden brown and cooked through, 35–40 minutes. Remove from the oven and let cool slightly, 2–3 minutes. Unmold the buns and serve warm, or transfer to a wire rack and let cool completely.",
    )
    r51 = Recipe(
        user_id=11,
        title='Roasted Duck Pizza with Figs and Arugula',
        description="This pizza features a killer combination of rich duck, sweet figs, peppery arugula, and a salty-sweet hoisin drizzle that you can't get in any restaurant! This recipe calls for Shaoxing rice wine, a type of Chinese rice wine that hails from Shaoxing, a city in China’s Zhejiang Province famous for rice wine production. It’s a key ingredient in many dishes and will create that authentic restaurant flavor you may have found difficult to replicate at home. If you can’t find it at your local grocery store, you can easily substitute a dry sherry cooking wine or mirin (a Japanese rice wine)",
        image_url='https://thewoksoflife.com/wp-content/uploads/2014/08/fig-duck-pizza-2.jpg',
        total_time='4 hours',
        servings='4 servings',
        ingredients='3 duck legs(skin on please!), 1 tablespoon Shaoxing wine, 1 tablespoon hoisin sauce, 1/2 teaspoon dark soy sauce, 1 teaspoon salt, 1/8 teaspoon pepper, 1/8 teaspoon five spice powder, 2 pizza dough(frozen or homemade), 2 tablespoons water, 1 tablespoon soy sauce, 1 teaspoon hoisin sauce, 2 teaspoons rice wine vinegar, 1 teaspoon honey, 1/8 teaspoon salt, 1/8 teaspoon five spice powder, 8 oz. grated mozzarella cheese (225g), 4 figs (sliced), 1 cup arugula, 2 tablespoons extra virgin olive oil, salt and black pepper (to taste)',
        directions="Rinse the duck legs and pat dry. Mix together all of the marinade ingredients and rub the marinade all over the duck. It would be best to let the duck marinate overnight, but not essential. Use the Pizza dough recipe featured in our Wild Mushroom & Garlic White Pizza. The dough recipe makes enough for 4 small pizzas, but the leftover dough can be frozen for use next time. Preheat the oven to 350 degrees F and place the duck on a foil lined sheet pan. Roast the duck for about 45 minutes and finish under the broiler to crisp the skin a bit. Once cooled, take the meat off the bone and shred it with a fork or just with your hands. Put about a tablespoon of hot water on the roasting pan and use a rubber spatula to deglaze it. Toss the meat in with the juices and duck fat (we don't play around here). If you're a little squeamish about the amount of duck fat on the pan, then drain some off before you deglaze it. Set your lovely duck aside. In a small sauce pan over low heat, add the water, soy, hoisin, rice wine vinegar, honey, salt, and five spice, and heat until it's thick enough to coat a spoon. Set aside. Preheat your oven to the highest temperature it can muster. You probably won't be able to reach the pizzeria's oven temperatures but try to come as close as possible. We got our oven in Beijing to almost 475 degrees F. This recipe makes about 2 medium sized pizzas. For each pizza, roll out your pizza dough on your baking sheet and brush on a thin layer of your sauce. You can use some the drippings from the duck pan for this purpose as well. Sprinkle with cheese and shredded duck, and dot with fig slices. Bake for 10-15 minutes, depending on how hot your oven is. Toss your arugula lightly with extra virgin olive oil, salt, and pepper, and sprinkle over the finished pizza. Drizzle the pizza with a little more of your sauce, and serve.",
    )
    r52 = Recipe(
        user_id=12,

...
def seed_instructions():
    ...
    in197 = Instruction(
        recipe_id = 58,
        list_order =1,
        specification  = 'Heat the broiler on high. Combine butter, uni, lemon zest and juice, oregano, red-pepper flakes, smoked paprika, garlic, and salt in a medium bowl. Using an electric mixer, beat the butter mixture until well combined. Set aside.',
        )
    in198 = Instruction(
        recipe_id = 58,
        list_order = 2,
